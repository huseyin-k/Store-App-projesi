        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 2, "/images/2.jpg", 1000m, "Keybord", false, "" },
                    { 3, 2, "/images/3.jpg", 500m, "Mouse", false, "" },
                    { 4, 2, "/images/4.jpg", 7000m, "Monitör", false, "" },
                    { 5, 2, "/images/5.jpg", 1500m, "Deck", false, "" },
                    { 6, 1, "/images/6.jpg", 25m, "History", false, "" },
                    { 7, 1, "/images/7.jpg", 45m, "Hamlet", false, "" },
                    { 8, 1, "/images/8.jpg", 145m, "Xp-Pen", true, "" },
                    { 9, 2, "/images/9.jpg", 2245m, "Samsung galaxy", true, "" },
                    { 10, 1, "/images/10.jpg", 3445m, "Hp Mouse", true, "" }
                });
